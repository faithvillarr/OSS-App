...
class Telemetry:
    ...
    @contextmanager
    def measure_message_processing(self, error_type_map: dict[type[Exception], str] | None = None) -> Generator[None, None, None]:
    ...
    @contextmanager
    def measure_poll_cycle(self) -> Generator[None, None, None]:
